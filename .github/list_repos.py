...
MA_libs_whitelist = ["ModelicaStandardLibrary", "Modelica_Synchronous", "PowerSystems", "VehicleInterfaces", "ElectricalEnergyStorage", "ExternalMedia", "Modelica-Compliance", "Modelica_DeviceDrivers", "Modelica_LinearSystems2", "Modelica_Requirements", "Modelica_StateGraph2"]
