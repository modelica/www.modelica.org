...
You are encouraged to submit a full paper of at least 4 pages, with a maximum of 10 pages, on the following topics:
 ...
 Please see the  [Authors' Guide](https://modelica.org/events/asian2024/authors/) for further information. You will be able to upload your paper using the [EasyChair Conference Management System](https://www.easychair.org/my/conference?conf=amc2024).

 <!-- The Easychair link will have to be updated when set up!!! -->

| Date | |
| --- | --- |
|August 1, 2024 |Deadline for paper submissions|
|September 1, 2024 |Submission of extended abstracts for presentation-only contributions, workshops and tutorial|
|October 1, 2024|Notification of acceptance for papers and presentations|
|October 30, 2024|Submission of final papers and one-page abstracts|
|November 25, 2024| Submission of final presentations|
...
The extended abstract in PDF format should be submitted through the  [EasyChair Conference Management System](https://www.easychair.org/my/conference?conf=amc2024) before **August 1st, 2024**. Industrial user presentations are an excellent way to present recent results to the Modelica community with less effort and overhead than a full paper submission. Please indicate whether you plan to give your presentation on-site or remotely in the submission form. These industrial user presentations differ from paper presentations, which we expect to be in-person. 
